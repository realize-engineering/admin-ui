            ...
            <div className="relative h-16 flex justify-between">
              ...
              <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                ...
                <Menu as="div" className="flex-shrink-0 relative ml-4">
                  <div>
                    <Menu.Button className="bg-white rounded-full flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pb-purple">
                      <span className="sr-only">Open user menu</span>
                      <UserCircleIcon className="rounded-full h-8 w-8 text-slate-800" />
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
